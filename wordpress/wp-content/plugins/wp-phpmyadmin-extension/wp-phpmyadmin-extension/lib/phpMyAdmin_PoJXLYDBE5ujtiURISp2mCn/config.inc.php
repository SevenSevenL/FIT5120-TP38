...
$cfg['blowfish_secret']					= 'wT-1~@=inTP7k})x0E6V)S/V!tXFlfh5' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_PoJXLYDBE5ujtiURISp2mCn/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
